...
- **Small, focused features** — Things that solve common gauge chart problems without adding complexity.
...
- **Non-canvas rendering** — Livegauge is canvas-only by design.
